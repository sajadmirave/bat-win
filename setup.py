...
# set all commands
os.system(f'doskey bat-ls={root_path_ls}\index.py') #bat-ls
os.system(f'doskey bat-cat={root_path_cat}\index.py') #bat-cat
os.system(f'doskey bat-touch={root_path_touch}\index.py') #bat-touch